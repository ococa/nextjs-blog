...
var Post = (_dec = (0, _typeorm.Entity)('posts'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('varchar'), _dec4 = (0, _typeorm.Column)('text'), _dec5 = (0, _typeorm.ManyToOne)('User', 'posts'), _dec6 = (0, _typeorm.OneToMany)('Comment', 'post'), _dec7 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp'
  ...
  (0, _initializerDefineProperty2["default"])(this, "author", _descriptor4, this);
  (0, _initializerDefineProperty2["default"])(this, "comments", _descriptor5, this);
  (0, _initializerDefineProperty2["default"])(this, "createAt", _descriptor6, this);
  (0, _initializerDefineProperty2["default"])(this, "updateAt", _descriptor7, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "author", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor6 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "createAt", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "updateAt", [_dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
